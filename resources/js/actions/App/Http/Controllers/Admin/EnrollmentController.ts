...
/**
* @see \App\Http\Controllers\Admin\EnrollmentController::updateStatus
 * @see app/Http/Controllers/Admin/EnrollmentController.php:51
 * @route '/admin/enrollments/{enrollment}/status'
 */
export const updateStatus = (args: { enrollment: string | number | { id: string | number } } | [enrollment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/enrollments/{enrollment}/status'
 */
updateStatus.url = (args: { enrollment: string | number | { id: string | number } } | [enrollment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
 ...
 * @route '/admin/enrollments/{enrollment}/status'
 */
updateStatus.patch = (args: { enrollment: string | number | { id: string | number } } | [enrollment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateStatus.url(args, options),
    method: 'patch',
})
 ...
 * @route '/admin/enrollments/{enrollment}/status'
 */
    const updateStatusForm = (args: { enrollment: string | number | { id: string | number } } | [enrollment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/enrollments/{enrollment}/status'
 */
        updateStatusForm.patch = (args: { enrollment: string | number | { id: string | number } } | [enrollment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateStatus.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const EnrollmentController = { index, updateStatus, destroy }
