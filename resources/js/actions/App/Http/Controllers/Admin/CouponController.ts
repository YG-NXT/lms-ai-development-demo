 ...
 * @see app/Http/Controllers/Admin/CouponController.php:14
 * @route '/admin/coupons'
 */
 ...
 * @see app/Http/Controllers/Admin/CouponController.php:0
 ...
 * @see app/Http/Controllers/Admin/CouponController.php:25
 * @route '/admin/coupons'
 */
 ...
 * @route '/admin/coupons/{coupon}'
 */
export const destroy = (args: { coupon: string | number | { id: string | number } } | [coupon: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/admin/coupons/{coupon}'
 */
destroy.url = (args: { coupon: string | number | { id: string | number } } | [coupon: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { coupon: args }
    }
 ...
 * @route '/admin/coupons/{coupon}'
 */
destroy.delete = (args: { coupon: string | number | { id: string | number } } | [coupon: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
 ...
 * @route '/admin/coupons/{coupon}'
 */
    const destroyForm = (args: { coupon: string | number | { id: string | number } } | [coupon: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/coupons/{coupon}'
 */
        destroyForm.delete = (args: { coupon: string | number | { id: string | number } } | [coupon: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const CouponController = { index, create, store, show, edit, update, destroy }
