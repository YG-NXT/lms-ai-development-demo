 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Student\AnnouncementController::markAsRead
 * @see app/Http/Controllers/Student/AnnouncementController.php:64
 * @route '/student/announcements/{announcement}/read'
 */
export const markAsRead = (args: { announcement: string | number | { id: string | number } } | [announcement: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/student/announcements/{announcement}/read'
 */
markAsRead.url = (args: { announcement: string | number | { id: string | number } } | [announcement: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { announcement: args }
    }
 ...
 * @route '/student/announcements/{announcement}/read'
 */
markAsRead.post = (args: { announcement: string | number | { id: string | number } } | [announcement: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: markAsRead.url(args, options),
    method: 'post',
})
 ...
 * @route '/student/announcements/{announcement}/read'
 */
    const markAsReadForm = (args: { announcement: string | number | { id: string | number } } | [announcement: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/student/announcements/{announcement}/read'
 */
        markAsReadForm.post = (args: { announcement: string | number | { id: string | number } } | [announcement: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: markAsRead.url(args, options),
            method: 'post',
        })
    
    markAsRead.form = markAsReadForm
const AnnouncementController = { index, show, markAsRead }
