 ...
 * @see app/Http/Controllers/Admin/CourseController.php:34
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:46
 * @route '/admin/courses'
 */
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:64
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:77
 * @route '/admin/courses/{course}'
 */
 ...
 * @route '/admin/courses/{course}'
 */
    const updateForm = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/courses/{course}'
 */
        updateForm.put = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/admin/courses/{course}'
 */
        updateForm.patch = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:100
 * @route '/admin/courses/{course}'
 */
 ...
 * @route '/admin/courses/{course}'
 */
    const destroyForm = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/courses/{course}'
 */
        destroyForm.delete = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \App\Http\Controllers\Admin\CourseController::clone
 * @see app/Http/Controllers/Admin/CourseController.php:110
 * @route '/admin/courses/{course}/clone'
 */
export const clone = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
clone.definition = {
    methods: ["post"],
    url: '/admin/courses/{course}/clone',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/admin/courses/{course}/clone'
 */
clone.url = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { course: args }
    }
 ...
 * @route '/admin/courses/{course}/clone'
 */
clone.post = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: clone.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/courses/{course}/clone'
 */
    const cloneForm = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/courses/{course}/clone'
 */
        cloneForm.post = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: clone.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\Admin\CurriculumController::curriculum
 * @see app/Http/Controllers/Admin/CurriculumController.php:20
 * @route '/admin/courses/{course}/curriculum'
 */
export const curriculum = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: curriculum.url(args, options),
    method: 'get',
})
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
curriculum.url = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { course: args }
    }
    ...
    return curriculum.definition.url
            .replace('{course}', parsedArgs.course.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
curriculum.get = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: curriculum.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
curriculum.head = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: curriculum.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
    const curriculumForm = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: curriculum.url(args, options),
        method: 'get',
    })
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
        curriculumForm.get = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: curriculum.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/courses/{course}/curriculum'
 */
        curriculumForm.head = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: curriculum.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
