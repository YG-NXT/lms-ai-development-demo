...
/**
* @see \App\Http\Controllers\Admin\AnnouncementController::students
 * @see app/Http/Controllers/Admin/AnnouncementController.php:117
 * @route '/admin/announcements/students/{course}'
 */
export const students = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/announcements/students/{course}'
 */
students.url = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
 ...
 * @route '/admin/announcements/students/{course}'
 */
students.get = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: students.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/announcements/students/{course}'
 */
students.head = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: students.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/announcements/students/{course}'
 */
    const studentsForm = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/announcements/students/{course}'
 */
        studentsForm.get = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: students.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/announcements/students/{course}'
 */
        studentsForm.head = (args: { course: string | number | { id: string | number } } | [course: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
